...
def run_ga(individuos, n_clientes, n_centroslocales, n_centrosregionales, n_periodos, n_productos, n_vehiculos_s, n_vehiculos_p, capacidad_cr, capacidad_cl, capacidad_vehiculos_p, capacidad_vehiculos_s, demanda_clientes, demand_cl_poblation, inventario, costo_instalaciones_cl, costo_instalaciones_cr, costo_compraproductos, costo_transporte, costo_inventario, costo_rutas_s, costo_rutas_p, costo_vehiculos_s, costo_vehiculos_p, costo_humano, w1, w2, final_inventarioQ, final_inventarioI, valores_f1, valores_f2, valores_ft, demand_cr_poblation, n_generaciones, prob_mut, colector, idx_pa):
    ...
    # almacenaje del mejor individuo en el colector
    colector.value[idx_pa].append([mjr_ind, mjr_Q, mjr_I, mjr_f1, mjr_f2, mj_fit])
    # almacenaje de los mejores individuos de cada generacion en el colector
    colector.value[idx_pa+2].append([bob_ind, bob_Q, bob_I, bob_f1, bob_f2, bob_fitness])
...
# algoritmo del siguiente hilo
# funcion que corre el algoritmo genetico
def run_ga2(individuos, n_clientes, n_centroslocales, n_centrosregionales, n_periodos, n_productos, n_vehiculos_s, n_vehiculos_p, capacidad_cr, capacidad_cl, capacidad_vehiculos_p, capacidad_vehiculos_s, demanda_clientes, demand_cl_poblation, inventario, costo_instalaciones_cl, costo_instalaciones_cr, costo_compraproductos, costo_transporte, costo_inventario, costo_rutas_s, costo_rutas_p, costo_vehiculos_s, costo_vehiculos_p, costo_humano, w1, w2, final_inventarioQ, final_inventarioI, valores_f1, valores_f2, valores_ft, demand_cr_poblation, n_generaciones, prob_mut, colector, idx_pa):
    # Operadores geneticos para n_generacion
    bob_ind = []
    bob_cr_dem = []
    bob_cl_dem = []
